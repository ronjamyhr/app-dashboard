...
        input.simulate('change', { target: {name: 'username', id: 'email', value: 'u' },preventDefault:() => {}})
        
...
   });
    ...
    it('should throw error if passwordinput is invalid', () => {
        ...
        input.simulate('change', { target: {name: 'password', id: 'password', value: '1'},preventDefault:() => {}})
    ...
        const inputEmail = loginForm.find('#email')
        ...
        inputEmail.simulate('change', { target: {name: 'username', id: 'email', value: 'user@test.se' },preventDefault:() => {}})
        inputPassword.simulate('change', { target: {name: 'password', id: 'password', value: '123456'},preventDefault:() => {}})
