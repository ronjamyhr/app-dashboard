...
class SlackMessages extends React.Component<{}, IState> {
    ...
    getSlackMessages() {
        axios.get(`https://slack.com/api/pins.list?token=${tokenUrl}&channel=CNVGEMZPC`)
            .then((result: any) => {
                this.setState({
    ...
    getSlackUsers() {
        axios.get(`https://slack.com/api/users.list?token=${tokenUrl}`)
            .then((res: any) => {
                this.setState({
        ...
        return (
            <div className="slackmessage-container">
                ...
                <div className="slackmessage-posts-container">
                    <ul>
                        {pinnedSlackMessages && pinnedSlackMessages.map(post => (
                            <li key={post.id}>
                                <div className="slackmessages-post-wrapper">
                                    ...
                                    <Emoji className="slackmessages-post-text" text={post.slackMessage} />
                                    <p className="slackmessages-post-user">- {post.slackUsername}</p>
                                </div>
                            </li>
                        ))}
                    </ul>
